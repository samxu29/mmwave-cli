...
local nframes_master            =   100    -- Number of Frames for Master (100 x 100ms = 10s total capture)
...
capture_directory         =   "capture_" .. timestamp   -- recommended to change between captures - timestamp does this automatically
n_files_allocation        =   0      -- 0: auto-allocate based on capture size
data_packaging            =   0      -- 0: 16-bit, 1: 12-bit
num_frames_to_capture     =   0      -- 0: default - TDA follows FrameConfig's own frame count (100, set above).
